export default [
    [
        "Solunum dış ortamdan alınan hava içerisindeki oksijenin solunum yolları aracılığıyla akciğerlere taşınmasını ve akciğere kan aracılığıyla getirilen karbondioksitin solunum yolları aracılığıyla dış ortama aktarılmasını ifade eder. Solunum sisteminin en önemli fonksiyonu gaz alışverişidir. Dışardan havanın akciğerlere alınmasına inspirasyon, akciğerlerden kirli havanın atılmasına ise ekspirasyon adı verilir. Solunumun bu kısmı dış solunumu ( external solunum ) ifade eder. İç Solunum ( internal solunum ) ise kanda bulunan oksijenin hücrelere ve hücrelerdeki karbondioksitin kana transfer edildiği gaz alışverişini ifade eder.  İnspirasyonun en önemli kası diyafram kasıdır. Diyafram kasının kasılması ile göğüs kafesi genişler ve dışarıdaki hava akciğerlere çekilir. İnspirasyonu takip eden ekspirasyon ise pasif bir olay olup hava bu esnada dışarı atılır. \n" +
        "\n" +
        "Solunum sistemi solunum yolları ve akciğerler olarak iki grupta incelenir. Solunum sisteminin ana organı akciğerlerdir.\n" ,
        ...
        "<i>a.</i> Vücudun ihtiyacı olan oksijeni sağlamak. Karbondioksitin vücuttan atılmasını sağlamak.\n" +
        "<i>b.</i> Kanın hidrojen iyon konsantrasyonunu ( pH ) dengesini düzenlemek\n" +
        "<i>c.</i> Konuşmak için gerekli sesleri üretmek ( Fonasyon )\n" +
        "<i>d.</i> Vücudu mikroorganizmalara karşı korumak.\n" ,
    ...
    [
        ...
        "\n" +
        "The respiratory system is divided into two groups as airways and lungs. The main organ of the respiratory system is the lungs.\n" ,


        "<strong>Physiology of the Respiratory System</strong>\n" +
        "\n" +
        "For the continuity of human life, the body must constantly receive oxygen. Carbon dioxide is produced as a result of the use of oxygen in the body. As a result, the most important factor that activates the respiratory system is the increase in the rate of carbon dioxide in the blood. Most of the oxygen that passes from the lungs to the blood through the alveoli is carried by binding to hemoglobin in the blood. Carried oxygen is pumped through the pulmonary vein to the heart and from there to the body and carried to the cells and tissues. The carbon dioxide formed here is bound to hemoglobin and brought to the heart via the main veins and then to the lungs via the pulmonary artery. Here, carbon dioxide passing from the alveolar walls to the alveolar sacs is expelled by the respiratory tract.\n" +
        "\n" +
        "<strong></i>Functions of the respiratory system</i></strong>\n" +
        "<i>a.</i> To provide the oxygen that the body needs. To remove carbon dioxide from the body.\n" +
        "<i>b. </i>Regulating the hydrogen ion concentration (pH) balance of the blood\n" +
        "<i>c.</i> Producing the sounds necessary for speaking (Phonation)\n" +
        ...
        "Some basic concepts about breathing\n" +
        "\n" +
        "<strong>Apnea:</strong> Respiratory arrest\n" +
        "<strong>Dyspnea:</strong> Difficulty Breathing\n" +
        "<strong>Cyanosis: </strong>Bruising of the skin due to lack of oxygen\n" +
        "<strong>Bradypnea:</strong> respiratory rate less than 12 per minute\n" +
        "<strong>Hyperpnea:</strong> Respiratory rate greater than 20 per minute\n"
    ],
    [
        "A respiração refere-se ao transporte de oxigénio no ar retirado do ambiente externo para os pulmões, através do trato respiratório, e à transferência de dióxido de carbono trazido para os pulmões, através do sangue, para o ambiente externo através do trato respiratório.\n" +
        "A função mais importante do sistema respiratório é a troca de gás. A entrada de ar do exterior para os pulmões é chamada de inspiração, e a remoção do ar poluído dos pulmões é chamada expiração. Esta parte da respiração refere-se à respiração externa. Respiração Interna refere-se à troca de gás na qual o oxigénio no sangue é transferido para as células e o dióxido de carbono nas células é transferido para o sangue. O músculo mais importante da inspiração é o diafragma. Com a contração do músculo diafragma, a caixa torácica expande-se e o ar exterior é atraído para os pulmões. Expiração após inspiração é um evento passivo e o ar é expulso durante este tempo.\n" +
        "\n" +
        "O sistema respiratório é dividido em dois grupos: vias respiratórias e pulmões. O principal órgão do sistema respiratório são os pulmões.\n" ,

        "<strong>Fisiologia do Sistema Respiratório</strong>\n" +
        "\n" +
        "Para a continuidade da vida humana, o corpo deve receber constantemente oxigénio. O dióxido de carbono é produzido como resultado do uso de oxigénio no corpo. Como resultado, o fator mais importante que ativa o sistema respiratório é o aumento da taxa de dióxido de carbono no sangue. A maior parte do oxigénio que passa dos pulmões para o sangue através dos alvéolos é transportado por ligação à hemoglobina no sangue. O oxigénio transportado é bombeado através da veia pulmonar para o coração e daí para o corpo e transportado para as células e tecidos. O dióxido de carbono formado aqui está ligado à hemoglobina e trazido para o coração através das veias principais e depois para os pulmões através da artéria pulmonar. Aqui, o dióxido de carbono que passa das paredes alveolares para o saco alveolar é expelido pelo trato respiratório.\n" +
        "\n" +
        "<strong><i>Funções do sistema respiratório</i></strong>\n" +
        "<i>a.</i> Para fornecer o oxigénio de que o corpo precisa. Para remover dióxido de carbono do corpo.\n" +
        "<i>b.  </i>Regulação do equilíbrio da concentração de iões de hidrogénio (pH) do sangue\n" +
        "<i>c. </i>Produzir os sons necessários para falar (Fonética)\n" +
        ...
        "\n" +
        "<strong>Apneia:<strong> Paragem respiratória\n" +
        "<strong>Dispneia:<strong> Dificuldade em Respirar\n" +
        "<strong>Cianose:<strong> Hematomas na pele por falta de oxigénio\n" +
        "<strong>Bradipneia: <strong>Taxa respiratória inferior a 12 por minuto\n" +
        "<strong>Hiperpneia:<strong> Taxa respiratória superior a 20 por minuto\n"
    ],
    [
      "ATMUNGSSYSTEM\n" +
      "\n" +
      "Atmung bezieht sich auf den Transport von Sauerstoff aus der Luft zu den Lungen und durch die Atemwege ausgeschiedenes Kohlendioxid, welches durch das Blut zu den Lungen gebracht wird. Die wichtigste Funktion des Atmungssystems ist der Gasaustausch. Das Ansaugen von Luft von außen in die Lunge wird als Inspiration bezeichnet, und das Entfernen von verschmutzter Luft aus der Lunge wird als Exspiration bezeichnet. Dieser Teil der Atmung bezieht sich auf die äußere Atmung. Innere Atmung bezeichnet den Gasaustausch, bei dem der Sauerstoff des Blutes auf die Zellen und das Kohlendioxid der Zellen auf das Blut übertragen wird. Der wichtigste Inspirationsmuskel ist das Zwerchfell. Durch die Kontraktion des Zwerchfellmuskels dehnt sich der Brustkorb aus und die Außenluft wird in die Lunge gesaugt. Das Ausatmen nach dem Einatmen ist ein passives Ereignis, und während dieser Zeit wird Luft ausgestoßen.\n" +
      "Das Atmungssystem wird in zwei Gruppen unterteilt, in die Atemwege und die Lunge. Das Hauptorgan des Atmungssystems ist die Lunge.\n" ,

      "<strong>Physiologie des Atmungssystems</strong>\n" +
      "\n" +
      "Für die Kontinuität des menschlichen Lebens muss der Körper ständig Sauerstoff erhalten. Kohlendioxid entsteht durch die Verwendung von Sauerstoff im Körper. Infolgedessen ist der wichtigste Faktor, der das Atmungssystem aktiviert, die Erhöhung der Kohlendioxidrate im Blut. Der größte Teil des Sauerstoffs, der von den Lungen durch die Alveolen ins Blut gelangt, wird durch Bindung an Hämoglobin im Blut transportiert. Der transportierte Sauerstoff wird durch die Lungenvene zum Herzen und von dort zum Körper gepumpt und zu den Zellen und Geweben transportiert. Das dabei entstehende Kohlendioxid wird wieder an das Hämoglobin gebunden und über die Hauptvenen zum Herzen und dann über die Lungenarterie zur Lunge transportiert. Hier wird Kohlendioxid, das von den Alveolarwänden zu den Alveolarsäcken gelangt, durch die Atemwege ausgestoßen.\n" +
      "\n" +
      "<strong><i>Funktionen des Atmungssystems</i></strong>\n" +
      "<i>a.</i> Um den Sauerstoff bereitzustellen, den der Körper benötigt. Um Kohlendioxid aus dem Körper zu entfernen.\n" +
      "<i>b. </i>Regulierung des Gleichgewichts der Wasserstoffionenkonzentration (pH) des Blutes\n" +
      "<i>c.</i> Erzeugung der zum Sprechen notwendigen Laute (Phonation)\n" +
      ...
      "\n" +
      "<strong>Apnoe:</strong> Atemstillstand\n" +
      "<strong>Dyspnoe:</strong> Atembeschwerden\n" +
      "<strong>Zyanose:</strong> Bluterguss der Haut durch Sauerstoffmangel\n" +
      "<strong>Bradypnoe:</strong> Atemfrequenz weniger als 12 pro Minute\n" +
      "<strong>Hyperpnoe:</strong> Atemfrequenz größer als 20 pro Minute\n"
    ]
]
