export default [
    ...
    [
        ...
        "- To provide the oxygen that the body needs. To remove carbon dioxide from the body.\n" +
        "- Regulating the hydrogen ion concentration (pH) balance of the blood\n" +
        "- Producing the sounds necessary for speaking (Phonation)\n" +
        "- To protect the body against microorganisms.\n" ,
        ...
        "-Bronchi (main bronchi, where the main trachea divides into two branches, right and left)\n" +
        "-Bronchioles (formations formed by the separation of bronchi into smaller airways)\n" ,
        ...
        "Cyanosis: Bruising of the skin due to lack of oxygen\n" +
        "Bradypnea: respiratory rate less than 12 per minute\n" +
        "Hyperpnea: Respiratory rate greater than 20 per minute\n"
    ],
    [
        ...
        "- Para fornecer o oxigénio de que o corpo precisa. Para remover dióxido de carbono do corpo.\n" +
        "- Regulação do equilíbrio da concentração de iões de hidrogénio (pH) do sangue\n" +
        "- Produzir os sons necessários para falar (Fonética)\n" +
        "- Para proteger o corpo contra microrganismos.\n" ,

        "Estruturas no sistema respiratório\n" +
        "- Boca\n" +
        "- Nariz\n" +
        "- Faringe\n" +
        "- Garganta (Laringe)\n" +
        "- Traqueia (Traqueia Principal)\n" +
        "- Brônquios (brônquios principais, onde a traqueia principal se divide em dois ramos, direita e esquerda)\n" +
        "-Bronquíolos (formações formadas pela separação de brônquios em vias respiratórias mais pequenas)\n" ,
        ...
        "Cianose: Hematomas na pele por falta de oxigénio\n" +
        "Bradipneia: Taxa respiratória inferior a 12 por minuto\n" +
        "Hiperpneia: Taxa respiratória superior a 20 por minuto\n"
    ],
    [
      "ATMUNGSSYSTEM\n" +
      "\n" +
      ...
      "- Um den Sauerstoff bereitzustellen, den der Körper benötigt. Um Kohlendioxid aus dem Körper zu entfernen.\n" +
      "- Regulierung des Gleichgewichts der Wasserstoffionenkonzentration (pH) des Blutes\n" +
      "- Erzeugung der zum Sprechen notwendigen Laute (Phonation)\n" +
      "- Zum Schutz des Körpers vor Mikroorganism\n" ,

      "Strukturen im Atmungssystem\n" +
      "-Mund\n" +
      "-Nase\n" +
      "-Pharynx (Rachen)\n" +
      "-Hals (Larynx)\n" +
      "-Trachea (Hauptluftröhre)\n" +
      "-Bronchi (Hauptbronchien, wo sich die Hauptluftröhre in zwei Zweige teilt, rechts und links)\n" +
      "- Bronchiolen (Formationen, die durch die Trennung von Bronchien in kleinere Atemwege gebildet werden)\n" ,
      ...
      "Zyanose: Bluterguss der Haut durch Sauerstoffmangel\n" +
      "Bradypnoe: Atemfrequenz weniger als 12 pro Minute\n" +
      "Hyperpnoe: Atemfrequenz größer als 20 pro Minute\n"
    ]
]
