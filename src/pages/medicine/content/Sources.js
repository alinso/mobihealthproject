export  default [
    [
        "1- Doğal Kaynaklar\n" +
        "   a. Bitkiler\n" +
        "   b. Hayvanlar ve İnsanlar\n" +
        "   c . Mikroorganizmalar\n" +
        "   d. İnorganik Maddeler ve Mineraller\n" +
        "2- Sentetik Maddeler\n" +
        ...
        "b. Hayvanlar ve insanlar; Hayvanlardan genelikle " +
        "hormon ve enzim tipindeki ilaçlarla, antitoksinler " +
        "elde edilir. Bunlara örnek olarak akrep, yılan " +
        "ve tetanoz anitoksinleri gösterilebilir. İnsanlardan" +
        "elde edilen en önemli ilaçlar kan ve kan " +
        "ürünleridir. Örneğin, insan plazması, insan albümini, " +
        " immünglobulinler gibi. Ayrıca insanlardan " +
        "hormon ve enzim tipinde ilaçlar da elde edilir.\n\n " +
        "c. Mikroorganizmalar; Çeşitli antibiyotikler ve " +
        "B12 vitamini mikroorganizmalardan elde edilir. \n\n" +
        "d. İnorganik Maddeler ve Mineraller; İyot, " +
        ...
        "yapılarak hazırlanır. Bu maddelere " +
        "yarısentetik maddeler denir.\n\n\n" +
        "3- DNA-Rekombinant Teknolıojisi (Gen Klonlama)" +
        " İle Üretilen İlaçlar:\n" +
        "Bu teknolojiyle üretilen ilaçlara aşılar örnek " +
        "gösterilebilir."
    ],
    ...
    "   c. Microorganisms\n" +
    "   d. Inorganic Matters and Minerals\n" +
    ...
    "3- DNA Recombinant Technology",
        ...
        "generally gained from animals. E.g. scorpion, snake and tetanus antitoxice." +
        "Most important medicines gained from human are blood and blood products. E.g." +
        "blood plasma, albuminin, immuneglobulin,etc. Also hormones and enyzmes kind of medicines are" +
        "gained from humans.\n\n" +
        "c. Microorganism: Various antibiotics and vitamin B12 are gained from microorganisms.\n\n" +
        ...
        "3- DNA- RECOMBINANT TECHNOLOGY ( GENE CLONING ) MEDICATIONS\n" +
        "Vaccines are adducible for DNA-recombinant technology."
    ],
    ...
    [
        ...
        "   b. Animais e Humanos\n" +
        "   c. Microorganismos\n" +
        "   d. Matérias e Minerais Inorgânicos\n" +
        ...
        "animais. " +
        "Os medicamentos mais importantes adquiridos do ser humano são o sangue e os produtos sanguíneos. Por " +
        "exemplo, plasma sanguíneo, albuminina, imuníbulina, etc. Também medicamentos hormonais são obtidos de " +
        "humanos.\n" +
